...
export const assignHotelSchema = z.object({
  ...
  one_bed: z.string().min(1, "قیمت اتاق ۱ تخته الزامی میباشد"),
  two_bed: z.string().min(1, "قیمت اتاق ۲ تخته الزامی میباشد"),
  plus_one: z.string().min(1, "قیمت تخت اضافه الزامی میباشد"),
  cld_6: z.string().min(1, "هزینه کودک الزامی میباشد"),
  cld_2: z.string().min(1, "هزینه کودک الزامی میباشد"),
  baby: z.string().min(1, "هزینه کودک الزامی میباشد"),
});
