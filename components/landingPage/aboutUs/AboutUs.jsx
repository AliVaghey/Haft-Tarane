            ...
            <div className="grid grid-cols-2 items-center justify-center gap-6 max-lg:grid-cols-1 ">
              <div className="rounded-xl border border-[#D9D9D9] bg-[#EFEFEF] p-9 lg:h-80">
                ...
                <p className="text-justify leading-9">
                  ...
                  در سطح بین‌المللی اعم از تور ، بلیط ، هتل است. با تمرکز بر
                  رضایت مشتریان، ما سعی می‌کنیم تجربه‌ی سفر شما را به یک تجربه‌ی
                  لاکچری و ناشناخته تبدیل کنیم. از لحظه‌ی رزرو تا رسیدن به مقصد،
                  ما همراه شما خواهیم بود و اطمینان می‌دهیم که تمام جزئیات سفر
              ...
              <div className="rounded-xl border  border-[#D9D9D9] bg-white  p-9 lg:h-80">
                ...
                <p className="text-justify leading-9">
                  ما در بی باک سفر مفتخریم که یکی از پیشروان در صنعت گردشگری
                  هستیم و خدماتی بی‌نظیر را به مسافران عزیز ارائه می‌دهیم. با
                  تیمی از کارشناسان حرفه‌ای در زمینه‌ های تور ، هتل و پرواز و
                  قطار ما بهترین شرایط و تجربه را برای سفرهای شما فراهم می‌کنیم
                </p>
              </div>
              {/* <div className="rounded-xl border  border-[#D9D9D9] bg-white  p-9 lg:h-80">
                <div className="w-1/2">
                  <p className="text-justify leading-9">
                    با تشکر از انتخاب شما برای سفر با بیباک سفر. ما در انتظار
              ...
              <div className="rounded-xl border border-[#D9D9D9] bg-[#EFEFEF] p-9  lg:h-80">
                ...
                <p className="text-justify leading-9">
                  نمایندگی فروش کلیه ایرلاین های داخلی و خارجی اعم از ماهان ،
                  آسمان ، کیش ایر ، قشم ایر ، آتا ، ساها ......و بهترین پروازهای
                  خارجی قطری ، امارات ، ترک ...... و همچنین نماینده فروش کلیه
                  تورهای داخلی و خارجی با تمام شرایطی که شما مسافرین عزیز
                  بخواهید .
                </p>
              </div>
            </div>
